...
\begin{figure}[!h]
	\includegraphics[scale=0.3]{arbreExemple.png}
	\centering
	\caption{arbre}
	\label{label-image7}
\end{figure}

Attention cependant, les propriétés du noeud N 10 ont été modifiées pour que celui-ci corresponde à l'état "Fermé" afin de pouvoir illustrer d'avantage de résultats. Nous pouvons désormais implémenter les opérations voulue afin d'observer le résultat qu'auront celles-ci sur notre arbre.
